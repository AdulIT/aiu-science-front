      ...
      */}
      ...
      <div className="flex w-full md:w-auto">
        <input
          ...
          className="flex-grow border border-gray-600 bg-[#2a2a2a] text-white px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-l-lg min-w-0"
        />
        <button
          className="border border-l-0 border-gray-600 bg-gray-700 hover:bg-gray-600 text-gray-200 font-medium px-4 py-2 rounded-r-lg rounded-l-none transition duration-200 flex-shrink-0"
      ...
      <div className="w-full md:w-72 flex-shrink-0">
        <Listbox value={type} onChange={setType}>
          <div className="relative">
            <ListboxButton className="w-full border border-gray-600 bg-[#2a2a2a] text-white text-left px-4 py-2 cursor-pointer rounded-lg hover:border-gray-500 transition-colors duration-200 flex items-center justify-between">
